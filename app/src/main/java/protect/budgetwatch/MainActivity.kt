...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        menuItems.add(
            MainMenuItem(
                R.drawable.purse, R.string.budgetsTitle,
                R.string.budgetDescription
            )
        )
        menuItems.add(
            MainMenuItem(
                R.drawable.transaction, R.string.transactionsTitle,
    ...
    internal class MenuAdapter(context: Context?, items: List<MainMenuItem>?) :
        ArrayAdapter<MainMenuItem?>(
            context!!, 0, items!!
        ) {
